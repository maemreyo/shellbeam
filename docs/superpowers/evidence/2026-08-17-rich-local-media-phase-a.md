...
| direct-cwd | 3 / 3 | 0 | 0 | 3 | NOT_RUN | frozen golden only |
...
| payload-64k | 1 / 1 | 0 | 0 | 1 | NOT_RUN | synthetic fixture exists; no real-host trial recorded |
| payload-256k | 1 / 1 | 0 | 0 | 1 | NOT_RUN | synthetic fixture exists; no real-host trial recorded |
| payload-1m | 1 / 1 | 0 | 0 | 1 | NOT_RUN | synthetic fixture exists; no real-host trial recorded |
| payload-4m | 1 / 1 | 0 | 0 | 1 | NOT_RUN | synthetic fixture exists; no real-host trial recorded |
| max-payload-7m | 3 / 3 | 3 | 0 | 0 | PASS | current 7 MiB manifest + three private token matches |
| format-png | 1 / 1 | 1 | 0 | 0 | PASS | 7 MiB PNG visibly entered model vision |
| format-jpeg | 1 / 1 | 0 | 0 | 1 | NOT_RUN | no real-host JPEG trial recorded |
| format-webp | 1 / 1 | 0 | 0 | 1 | NOT_RUN | no real-host WebP trial recorded |
...
At least one mandatory Phase A row is incomplete, including direct/collision trials, negative/unsupported/sensitive cases, JPEG/WebP, disclosure/confirmation, and both annotation audience variants. Therefore:

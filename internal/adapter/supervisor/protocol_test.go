...
func TestDecodeRequestAcceptsOnlyClosedProtocolV1Kinds(t *testing.T) {
	valid := []string{
		...
		`{"protocol_version":1,"kind":"output_ack","session_id":"persistent-session-a","generation_id":"generation-a","output_ack":{"offset":1024}}`,
...
func TestDecodeRequestRejectsUnknownVersionKindFieldsAndCrossKindPayloads(t *testing.T) {
	invalid := []string{
		...
		`{"protocol_version":1,"kind":"output_ack","session_id":"persistent-session-a","generation_id":"generation-a","output_ack":{"offset":-1}}`,

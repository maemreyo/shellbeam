...
go test -race ./internal/app/daemon ./internal/app/bridge ./internal/adapter/process ./internal/adapter/store ./internal/adapter/ipc ./internal/adapter/localfs ./internal/adapter/mcp ./internal/observability ./tests/contract ./tests/integration -count=1
